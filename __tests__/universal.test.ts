...
describe("Test For Universal Profile API", () => {
  ...
  it("It should response 200 data for 0x02731b4bd27eb1234049ecb082c4dc1f3640bb93d8d9736c898c69ad385dc66a7e", async () => {
    const res = await GET(
      generateRequestBody(
        "0x02731b4bd27eb1234049ecb082c4dc1f3640bb93d8d9736c898c69ad385dc66a7e"
      )
    );
    expect(res.status).toBe(200);
    const json = await res.json();
  ...
  it("It should response 200 data for 0x7cbba07e31dc7b12bb69a1209c5b11a8ac50acf5", async () => {
    const res = await GET(
      generateRequestBody("0x7cbba07e31dc7b12bb69a1209c5b11a8ac50acf5")
    );
    expect(res.status).toBe(200);
    const json = await res.json();
  ...
  it("It should response 200 data for lilgho.lens", async () => {
    const res = await GET(generateRequestBody("lilgho.lens"));
    expect(res.status).toBe(200);
    const json = await res.json();
  ...
  it("It should response 200 data for 0x7241dddec3a6af367882eaf9651b87e1c7549dff", async () => {
    const res = await GET(
      generateRequestBody("0x7241dddec3a6af367882eaf9651b87e1c7549dff")
    );
    expect(res.status).toBe(200);
    const json = await res.json();
  ...
  it("It should response 200 data for noun124.eth", async () => {
    const res = await GET(generateRequestBody("noun124.eth"));
    expect(res.status).toBe(200);
    const json = await res.json();
  ...
  it("It should response 200 data for 0x3ddfa8ec3052539b6c9549f12cea2c295cff5296", async () => {
    const res = await GET(
      generateRequestBody("0x3ddfa8ec3052539b6c9549f12cea2c295cff5296")
    );
    expect(res.status).toBe(200);
    const json = await res.json();
  ...
  it("It should response 200 data for brantly.eth", async () => {
    ...
    expect(res.status).toBe(200);
    const json = await res.json();
    const linksOBJ = json.find(
      (x: { platform: string }) => x.platform === "ens"
    ).links;
  ...
  it("It should response 200 data for 0xd8da6bf26964af9d7eed9e03e53415d37aa96045", async () => {
    const res = await GET(
      generateRequestBody("0xd8da6bf26964af9d7eed9e03e53415d37aa96045")
    );
    expect(res.status).toBe(200);
  });
  ...
  it("It should response 200 data for 0xE0b3Ef5A61324acceE3798B6D9Da5B47b0312b7c", async () => {
    const res = await GET(
      generateRequestBody("0xE0b3Ef5A61324acceE3798B6D9Da5B47b0312b7c")
    );
    expect(res.status).toBe(200);
    const json = await res.json();
    expect(
      json.filter((x: { platform: string }) => x.platform === "lens").length > 1
    );
  });
  ...
  it("It should response 200 data for 0x638b1350920333d23a7a7472c00aa5c38c278b90", async () => {
    const res = await GET(
      generateRequestBody("0x638b1350920333d23a7a7472c00aa5c38c278b90")
    );
    expect(res.status).toBe(200);
    const json = await res.json();
    expect(
      json.find((x: { platform: string }) => x.platform === "dotbit")
    ).toBeTruthy();
  });
  ...
  it("It should response 200 data for аррӏе.eth", async () => {
    const res = await GET(generateRequestBody("аррӏе.eth"));
    expect(res.status).toBe(200);
    const json = await res.json();
    expect(
      json.find((x: { platform: string }) => x.platform === "farcaster")
  ...
  it("It should response 404 data for sujiyan.bnb", async () => {
    const res = await GET(generateRequestBody("sujiyan.bnb"));
    expect(res.status).toBe(404);
    const json = await res.json();
    expect(json.error).toBe("Invalid Identity or Domain");
  });
  it("It should response 200 data for shoni.eth", async () => {
    const res = await GET(generateRequestBody("shoni.eth"));
    expect(res.status).toBe(200);
    const json = await res.json();
